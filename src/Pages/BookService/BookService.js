...
const BookService = () => {
    ...
    useEffect(() => {
        fetch(`https://hidden-sands-54353.herokuapp.com/services/${serviceId}`)
            .then(res => res.json())
    ...
    const onSubmit = data => {
        ...
        axios.post('https://hidden-sands-54353.herokuapp.com/order', bookingInfo)
            .then(res => {
                ...
                <div className="border mb-3 mx-2">
                    <div className="row g-0">
                        <div>
                            ...
                            <h6 className="card-text container text-gray-400">{service?.description}</h6>
                            <h5 className="card-text"><small className="text-muted text-gray-400">Location: {service?.location}</small></h5>
                            <span className="fs-5 text-gray-400">Price: $ {service?.price}</span>
                        </div>
                            ...
                            <div className="card-body">
                                ...
                                <div>
                                    <form className="rounded-3xl container mx-2" onSubmit={handleSubmit(onSubmit)}>
                                        <h1 className="text-design">Booking Informations. <i className="far fa-address-card"></i></h1>
                                        ...
                                        <label className="text-black" htmlFor="">To:</label>

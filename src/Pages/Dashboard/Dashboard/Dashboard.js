...
function Dashboard(props) {
    ...
    const drawer = (
        <div>
            ...
            <Link to={`${url}/myorders`}><Button sx={{ backgroundColor: '#212529' }} className="mb-2" variant="contained">My Orders</Button></Link><br />
            <Link to={`${url}/review`}><Button sx={{ backgroundColor: '#212529' }} className="mb-2" variant="contained">Add A Review</Button></Link><br />
            ...
            {admin && <Box>
                ...
                <Link to={`${url}/addanewservice`}><Button sx={{ backgroundColor: '#212529' }} className="mb-2" variant="contained">Add A New Car</Button></Link>

                <Link to={`${url}/makeAdmin`}><Button sx={{ backgroundColor: '#212529' }} className="mb-2" variant="contained">Make Admin</Button></Link>

                <Link to={`${url}/manageallservices`}><Button sx={{ backgroundColor: '#212529' }} className="mb-2" variant="contained">Manage All Services</Button></Link>
